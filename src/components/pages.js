		...
		return (
			...
			<form className="d-flex flex-column flex-wrap flex-row justify-content-center align-items-around">
				...
				<div className="col-12 align-items-center">
                    ...
                    <label className="pl-2 mb-0" id="basic" onClick={this.update} >
				...
				<div className="col-12 align-items-center">
                    ...
                    <label className="pl-2 mb-0" id="custom" onClick={this.update} >
				...
				<div className="my-4 col-12 d-flex flex-row align-items-center justify-content-start">
					...
					<input className="pl-2" onChange={this.onChange} placeholder="0" id="pages" min="1" max="1000" step="1" type="number" required/>
				</div>
